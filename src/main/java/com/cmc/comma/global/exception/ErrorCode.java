...
public enum ErrorCode {
    ...
    INVALID_NICKNAME(HttpStatus.BAD_REQUEST, "닉네임은 한글, 영문, 숫자만 사용해 최대 10자까지 가능합니다."),
    ...
    REFRESH_TOKEN_REUSE_DETECTED(HttpStatus.UNAUTHORIZED, "재사용이 감지되어 세션이 만료되었습니다. 다시 로그인해주세요."),
